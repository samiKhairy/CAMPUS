...
For the CAMPUS project, we needed to evaluate which protocol to use for the bidirectional device--edge communication layer (covering both the downlink from the edge server and the uplink/acknowledgements from the devices). The three candidates are:
